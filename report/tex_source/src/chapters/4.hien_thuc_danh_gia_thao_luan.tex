...
\addlinespace
Trong lập trình Python, cú pháp nào được sử dụng để in ra màn hình chuỗi ``Hello World''? & \textit{(Ngoài phạm vi môn KHTN)} Hệ thống cần thông báo không tìm thấy thông tin trong sách giáo khoa, không tự ý trả lời bằng kiến thức ngoài học liệu chuẩn. & Không áp dụng (Ngoại vi) \\
\bottomrule
\end{tabular}
\end{table}
