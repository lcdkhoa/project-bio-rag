...
| ETL text bằng MODEL đọc cả trang | **ĐANG LÀM — bước 0** (D-91) | người dùng chốt 2026-08-25: bake-off trước, model đọc **cả trang**, Colab GPU, phạm vi cuối 12 quyển. Đo được: **0/4 model ứng viên** nhắc tới tiếng Việt trong model card → chất lượng DẤU là chưa đo, phải bake-off. Phiếu duyệt **97 ô / 15 trang** dựng xong (`python -m src.test.ocr_bakeoff --export`), chờ người duyệt. Thiết kế: `document/specs/2026-08-25-ocr-model-bakeoff-design.md` |
