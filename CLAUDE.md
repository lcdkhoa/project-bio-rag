...
| Kho ảnh **8 quyển CD/CTST** | **ĐANG CHẠY** (D-110, D-111) | `python main.py --image-only` khởi động 15:33 ngày 2026-08-25, không truyền `--book` vì checkpoint tự bỏ qua 4 quyển KNTT (1 md5/trang). Xong 6/8: `6_CD` 418 doc/179 tr · `6_CTST` 256/204 · `7_CD` 269/171 · `7_CTST` **149**/188 · `8_CD` 324/207 · `8_CTST` 241/223. Tỉ lệ có `figure_label` **86–92%** (KNTT 93–97%). Còn `9_CD`, `9_CTST`. **`7_CTST` thấp bất thường** (0,79 crop/trang so với 1,25 của 6_CTST) — phải mở trang xem bằng mắt. ETA hiệu chỉnh ≈ 4 h 50 vì spike bỏ sót pha nhúng CLIP (9,4 phút/418 hình) |
