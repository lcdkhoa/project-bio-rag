...
| Gỡ `LAYOUT_VARIANT = "kntt"` | **CHƯA — và nó ĐANG gắn nhãn SAI 11 459 chunk** (D-109) | `src/etl/image_processor.py:4105`, `make_image_processor()` vẫn luôn trả KNTT (D-64 đã đảo chiều D-50). Đếm trên index: `(CD, kntt) 5 282` · `(CTST, kntt) 6 177` · `(KNTT, kntt) 4 934` → **69,9% chunk mang `variant` sai, 0 chunk đúng**. Không test nào bắt được vì hằng số luôn tự nhất quán. Chỉ metadata sai; **các số recall/MRR đã công bố (D-82, D-87) KHÔNG bị ảnh hưởng** vì không đường nào lọc theo trường này |
